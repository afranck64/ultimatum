...
def test_index(client):
    txx.test_index(client, TREATMENT, completion_code_prefix=COMPLETION_CODE_PREFIX)
...
def test_resp_done_success(client):
    txx.test_resp_done_success(client, TREATMENT, completion_code_prefix=COMPLETION_CODE_PREFIX)

def test_resp_done_both_models(client):
    txx.test_resp_done_both_models(client, TREATMENT, completion_code_prefix=COMPLETION_CODE_PREFIX)
