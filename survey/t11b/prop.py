...
from survey.globals import AI_SYSTEM_DESCRIPTION_BRIEF_PROPOSER, AI_SYSTEM_DESCRIPTION_EXTENDED_PROPOSER, AI_SYSTEM_INFORMED_RESPONDER_INFORMATION_PROPOSER, AI_SYSTEM_DESCRIPTION_USAGE_PROPOSER
...
def index_dss():
    messages = [AI_SYSTEM_DESCRIPTION_BRIEF_PROPOSER, AI_SYSTEM_INFORMED_RESPONDER_INFORMATION_PROPOSER, AI_SYSTEM_DESCRIPTION_EXTENDED_PROPOSER, AI_SYSTEM_DESCRIPTION_USAGE_PROPOSER]
